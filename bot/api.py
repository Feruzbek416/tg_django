...
def create_feedback(user_id,body,age,name,surname,school):
    url = f"{BASE_URL}/feedbacks/"
    if body and user_id and age and name and surname and school:
        post = requests.post(url=url,data={"user_id":user_id,"body":body,'age':age,'name':name,'surname':surname,"school":school})
